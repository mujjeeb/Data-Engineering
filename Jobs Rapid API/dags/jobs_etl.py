...
def get_data_from_api():
    ...
    querystring = {"query":"Data Engineer in UK","page":"1","num_pages":"1","date_posted":"month","remote_jobs_only":"true"}
...
with DAG(
    dag_id='rapid_api_v1',
    description='DE job vacancies in the United Kingdom: an ETL pipeline',
...
load_db=PythonOperator(
    ...
    op_args=[df_rapid,'new_rapid_api_job']
